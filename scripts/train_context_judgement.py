...
from context_judgement_corpus import build
...
def main():
 ap=argparse.ArgumentParser();ap.add_argument("--graph",default="artifacts/flywire/connectome.json");ap.add_argument("--epochs",type=int,default=300);ap.add_argument("--out",type=Path,default=Path("artifacts/context-judgement-v1"));a=ap.parse_args()
