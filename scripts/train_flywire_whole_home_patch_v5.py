...
from whole_home_patch_corpus_v5 import build
...
def main():
 a=argparse.ArgumentParser();a.add_argument("--graph",default="artifacts/flywire/connectome.json");a.add_argument("--epochs",type=int,default=240);a.add_argument("--out",type=Path,default=Path("artifacts/flywire-whole-home-v5"));q=a.parse_args()
 ...
 rep={"truth":d["truth"],"source_sha256":EXPECTED_SHA256,"graph_sha256":GRAPH_SHA,"train_examples":len(d["train"]),"dev_examples":len(d["dev"]),"final_test_examples":len(d["sealed"]),"runs":{}}
