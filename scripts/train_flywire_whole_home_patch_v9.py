...
def main():
 a=argparse.ArgumentParser();a.add_argument("--graph",default="artifacts/flywire/connectome.json");a.add_argument("--epochs",type=int,default=240);a.add_argument("--out",type=Path,default=Path("artifacts/flywire-whole-home-v9"));q=a.parse_args()
 ...
 rep={"truth":"v9_balanced_full_operation_eval","source_sha256":EXPECTED_SHA256,"graph_sha256":GRAPH_SHA,"train_examples":len(d["train"]),"dev_examples":len(d["dev"]),"final_test_examples":len(d["sealed"]),"runs":{}}
